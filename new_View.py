...
class View(tk.Tk):
    def __init__(self):
        ...
        btn = tk.Button(self, text="Browse Audio File", command=self.browseFile)
        btn.pack()

        low_btn = tk.Button(self, text="Low", command=lambda: self.displayGraph("low") )
        low_btn.pack()
        mid_btn = tk.Button(self, text="Mid", command=lambda: self.displayGraph("mid") )
        mid_btn.pack()
        high_btn = tk.Button(self, text="High", command=lambda: self.displayGraph("high") )
        high_btn.pack()
